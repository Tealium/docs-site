...
The following example creates a basic VIP audience using [the previously created badge](https://docs.tealium.com/audiencestream-attributes-badges/). Since we’re targeting this audience with an email campaign, we’ll also check for a known email address. Finally, we’ll show how to expand the audience with additional conditions.
...
1. Enter a **Name** to uniquely identify the audience, such as `VIP`. 
<blockquote>
