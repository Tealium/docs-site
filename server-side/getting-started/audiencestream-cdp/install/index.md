...
Tealium iQ requires an installation of the Universal Tag (`utag.js`) on all pages of your site and the Tealium Collect tag, which is easily added with a few clicks from the tag marketplace. Additional benefits of this option include access to the [extension marketplace](https://docs.tealium.com/extensions-list/), for preparing and transforming your data before it's sent to AudienceStream, and the use of [Web Companion](https://docs.tealium.com/web-companion/) and [Tealium Tools](https://docs.tealium.com/tealium-tools-browser-extension/) to validate and extend your installation.

Installation components:

* [Tealium iQ Tag Management](https://docs.tealium.com/what-is-tealium-iq/)
* [Tealium Universal Tag (`utag.js`)](https://docs.tealium.com/platforms/javascript/install/)
* [Tealium Collect Tag](https://docs.tealium.com/tealium-collect-tag/)
