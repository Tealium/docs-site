...
|------------|--------------|-----------------|------------|
|![](https://docs.tealium.com/images/server-side/getting-started/audiencestream-cdp/attributes-badges/big-spenders.png) | ![](https://docs.tealium.com/images/server-side/getting-started/audiencestream-cdp/attributes-badges/cart-abandoner.png) | ![](https://docs.tealium.com/images/server-side/getting-started/audiencestream-cdp/attributes-badges/multi-device-user.png) |  ![](https://docs.tealium.com/images/server-side/getting-started/audiencestream-cdp/attributes-badges/test-group-b.png) | 
