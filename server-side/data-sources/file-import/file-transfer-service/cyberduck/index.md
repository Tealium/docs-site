...
Upload files by dragging and dropping your CSV files into Cyberduck. If this is a new S3 bucket (an empty bucket), see [Uploading a File to an Empty S3 Bucket](https://docs.tealium.com/aws-s3/#use-amazon-cli-to-upload-files-to-an-empty-s3-bucket) for instructions on uploading your first file.
