...
If you haven't already, [create a data source](https://docs.tealium.com/create-data-source/) for your iQ Tag Management account, copy the unique data source key-value, then proceed with one of the following methods:
...
<blockquote>
If you already have the Tealium Collect tag [check that you have the most recent version](https://docs.tealium.com/template-status-checker/)
</blockquote>

1. Paste the data source key into the **Data Source Key** field in the tag configuration, as seen here:  
      ![](https://docs.tealium.com/images/server-side/iq-data-source-key.jpg)
...
![](https://docs.tealium.com/images/server-side/datasourcekey-lookup-table.jpg)
