...
1. Enter the conditions for your filter.  
    ![](https://docs.tealium.com/images/server-side/whiteui-udh-audiencediscovery-add-audience.png)  
...
1. In the **As a new audience** field, enter a descriptive name for your audience.
<blockquote>
The name must not exceed 127 characters and must contain only ASCII characters (codes 0-127).
</blockquote>
![](https://docs.tealium.com/images/server-side/whiteui-udh-audiencediscovery-add-audience-save-save-as-new-audience.png)
1. Click **Save**.
1. Save and publish.
...
1. Select an audience to view.![](https://docs.tealium.com/images/server-side/whiteui-udh-audiencediscovery-load-audience.png)
...
1. (Optional) Click a bar in the chart for a more granular view.  
    ...
    From this view, you can see the definition of the attribute used to filter the results. You can optionally double-click the attribute to edit the current definition and add additional conditions without the need to navigate back to the primary interface.
<blockquote>
...
1. Use the **Search** field to search for a specific perspective, or filter the available perspective by Visit or Visitor scope.  ![](https://docs.tealium.com/images/server-side/-whiteui-udh-audiencediscovery-view-different-perspectives.png)
...
In the following example, **Average visit duration in minutes** (the default value) is selected as a perspective from which to view the currently displayed audience data.  
      ![](https://docs.tealium.com/images/server-side/whiteui-udh-audiencediscovery-perspective-view-filter.png)
