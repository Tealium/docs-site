...
The system only finds (discovers) visitors with activity between the dates chosen. Visitors that have not had activity within the specified date range or that were purged due to the [profile retention time](https://docs.tealium.com/manage-audiences/) are not searched.
