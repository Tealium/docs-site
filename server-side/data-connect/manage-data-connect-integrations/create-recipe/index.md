...
Search for the **app** you want to integrate into Tealium. For schedule-based recipes, the trigger is the schedule that you configure.
   1. In the **Trigger** step, choose the trigger for your business case.
<blockquote>
...
<blockquote>
Ensure you complete [Step 3](https://docs.tealium.com/create-recipe-data-connect/#step-3-configure-error-handling) to finish configuring error handling in your recipe. If you do not stop the recipe as described in Step 3, automatic error notifications will not work.
</blockquote>
...
1. Enter the information from your [Tealium Connect data source](https://docs.tealium.com/tealium-connect-data-source/).
...
<blockquote>
Ensure your **Attributes to add** contain fields with unique names, ignoring case. <br> Tealium processes all event field names in lowercase.
</blockquote>
        ...
        * (Optional) Add any additional attributes you want to send to Tealium that are not necessarily from your app. For example, `tealium_event`, your `tealium_trace_id`, or `_dc_ttl_`, which describes how long the visit will last. 
<blockquote>
When using `tealium_trace_id` for debug purposes, you cannot send more than five events in one batch.
</blockquote>
