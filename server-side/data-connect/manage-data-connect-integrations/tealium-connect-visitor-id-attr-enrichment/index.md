...
1. Create a rule that identifies events from your Tealium Connect data source based on the built-in event attribute `tealium_datasource={{tealium_data_source_key}}` if this rule does not already exist. Your Data Source Key can be found in your [Tealium Connect data source](https://docs.tealium.com/tealium-connect-data-source/).
