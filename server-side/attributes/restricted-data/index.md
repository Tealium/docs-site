...
By default, restricted attributes are omitted from event feeds. This behavior can be changed in the settings for each feed. 
<blockquote>
Connectors that use an event feed as a data source always receive restricted attributes, regardless of how the event feed is configured.
</blockquote>
