...
For more about these status messages and how to use them, see [About Server-Side Saving and Publishing](https://docs.tealium.com/about-save-publish/).
...
You can also use the **Load this Version** option in [Version History](https://docs.tealium.com/ss-version-history/) to switch versions.