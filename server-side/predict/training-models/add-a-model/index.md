...
1. From the **Model Dashboard**, click **+ Add Model**.  
      ![](https://docs.tealium.com/images/predict/predict-v2-new-model.jpg)
...
For more information about excluding attributes, see [Decide what to predict](https://docs.tealium.com/decide-what-to-predict/).