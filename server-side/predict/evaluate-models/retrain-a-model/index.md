...
url: https://docs.tealium.com/server-side/predict/evaluate-models/retrain-a-model/
---
## Determine needed changes and prepare for retraining

Use the following sections as a guide to prepare your model for retraining. To edit a trained model or view included and excluded attributes, see [Review your model](https://docs.tealium.com/review-your-model/).
...
After your new version is trained, review the results of retraining following the guildelines in [Evaluate trainded models](https://docs.tealium.com/evaluate-trained-models/). Continue to refine your data and model properties if needed.
