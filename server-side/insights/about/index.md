...
<blockquote>
Insights must be enabled for your account. For additional information, [contact support](https://docs.tealium.com/support/).
</blockquote>
...
<blockquote>
If dashboard errors occur, check the **Templates > Template Details** screen. The dataset may need to be refreshed. For more information, see [Refresh a dataset](https://docs.tealium.com/manage-datasets/#refresh-a-dataset).
</blockquote>
...
To avoid having to create a custom dashboard in multiple profiles, you can export a custom dashboard to a JSON file and import this JSON file into other profiles. For more information, see [Export a custom dashboard](https://docs.tealium.com/manage-dashboards/#export-a-custom-dashboard).
...
<blockquote>
Insights users must also be a member of a permission group with view access to the Insights feature. For more information, see [Admin roles](https://docs.tealium.com/admin-roles/#user-admin) and [Permission groups](https://docs.tealium.com/permission-groups/). To manage Insights user roles, [contact support](https://docs.tealium.com/support/).
</blockquote>
...
Insights provides five reader roles and two author roles per profile. Additional reader and author roles can be purchased. For more information, [contact support](https://docs.tealium.com/support/).