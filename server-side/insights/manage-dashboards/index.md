...
![](https://docs.tealium.com/images/server-side/data-insights/dashboard-generated-message.png)
...
![](https://docs.tealium.com/images/server-side/data-insights/dashboard-deleted.png)
1. Click **Done**.
...
![](https://docs.tealium.com/images/server-side/data-insights/data-insights-scheduling-icon.png)
...
1. Click the Share icon and click **Share dashboard**.
   ![](https://docs.tealium.com/images/server-side/data-insights/data-insights-share-icon.png)
...
Threshold alerts send an email notification when a dashboard visual crosses a defined value. For setup instructions, examples, and filter behavior, see [Threshold alerts](https://docs.tealium.com/threshold-alerts/).
