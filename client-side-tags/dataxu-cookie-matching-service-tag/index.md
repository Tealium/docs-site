...
First, go to Tealium's tag marketplace and add the DataXu Cookie Matching Service tag (Learn more about [how to add a tag](https://docs.tealium.com/manage-tags/)).
