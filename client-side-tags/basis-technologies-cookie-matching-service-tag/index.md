...
url: https://docs.tealium.com/client-side-tags/basis-technologies-cookie-matching-service-tag/
---
...
First, go to Tealium's tag marketplace and add the Basic Technologies Cookie Matching Service tag (Learn more about [how to add a tag](https://docs.tealium.com/manage-tags/)).
