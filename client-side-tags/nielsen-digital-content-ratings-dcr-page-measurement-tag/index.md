...
First, go to the tag marketplace and add the Nielsen Digital Content Ratings (DCR) - Page Measurement Tag to your profile (See [Add a tag](https://docs.tealium.com/manage-tags/#add-a-tag)).
