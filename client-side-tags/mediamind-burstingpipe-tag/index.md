...
For this Tag, we recommend that you add and configure the [E-Commerce extension](https://docs.tealium.com/e-commerce-extension/). To override any of the E-Commerce mappings, manually map the data sources to their destinations where applicable.
