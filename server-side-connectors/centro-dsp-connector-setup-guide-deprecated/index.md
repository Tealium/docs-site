...
<blockquote>
This connector is deprecated and no longer available in the connector marketplace. For the current connector, see the [Basis Technologies DSP Connector](https://docs.tealium.com/basis-technologies-dsp-connector/).
</blockquote>
