...
Go to **Connect > Connectors**, find the **Google DV360 Customer Match** connector, and select an action. On the action screen, click the **Insights** tab.
...
<blockquote>
Tealium retrieves list statistics directly from Google DV 360, which may cause a difference between matches and the total volume of connector requests in this insight and the [Google DV 360 Customer Match connector](https://docs.tealium.com/google-dv-360-customer-match-connector/).
</blockquote>
