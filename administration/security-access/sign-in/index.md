---
title: Sign in to Tealium
description: How to sign in to the Tealium platform using email and password or SSO.
url: https://docs.tealium.com/administration/security-access/sign-in/
---
Sign in to Tealium at [https://my.tealiumiq.com](https://my.tealiumiq.com).
...
1. In the **Primary Account Name** field, enter your primary account name.
1. Click **Continue**.
1. Authenticate through your identity provider.

If you do not know your primary account name:

1. Click **Forgot primary account name?**
...
The **Frequently visited** section shows your recently accessed versions for quick access.
