...
Only an account admin is permitted to manage the setting. However, any user can reset their own MFA.

#### MFA was auto-enabled in my account on Feb 16, 2016? Can I disable it?
...
Yes. MFA applies to all profiles within your account.
