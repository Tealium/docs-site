...
[この指示]()に従ってAdobe Experience Cloud IDタグを構成し、iQ Tag Managementでタグを構成します。
...
1. iQ Tag Managementで、Data Layerタブに移動し、`utag_main_adobe_mcid` および `utag_main_aa_vid` という名前の2つの新しいファーストパーティクッキー変数を作成します。
