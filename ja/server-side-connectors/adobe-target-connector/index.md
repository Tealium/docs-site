...
コネクタマーケットプレイスにアクセスして新しいコネクタを追加します。コネクタを追加する一般的な手順については、[コネクタについて](https://docs.tealium.com/about-connectors/) の記事を参照してください。
...
<blockquote>
訪問のプロファイルを新規サイト訪問に対して Adobe Target が作成するのに十分な時間を確保するために、**訪問終了時にオーディエンス内** にトリガーを構成するか、1時間の [遅延アクション](https://docs.tealium.com/about-delayed-actions/) を使用することをお勧めします。
</blockquote>
