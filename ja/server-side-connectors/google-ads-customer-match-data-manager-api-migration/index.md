...
[Google Ads Customer Match コネクタ]()に、Google Data Manager API を使用する2つの新しいアクションが導入されます：
...
[Google Ads Customer Match コネクタ]()の既存の Google Ads API Customer Match アクションは、将来のリリースで廃止される予定です。
...
新しいアクションは、[Google Ads Customer Match コネクタ]()の既存の Google Ads Customer Match アクションと一緒に表示されます：
...
1. 既存の [Google Ads Customer Match コネクタ]() を開きます。
...
[Google Ads Customer Match コネクタ]()を使用する各アカウントプロファイルについて：
