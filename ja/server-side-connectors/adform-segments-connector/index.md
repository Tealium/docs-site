...
**コネクタマーケットプレイス**にアクセスし、新しいコネクタを追加します。コネクタの追加方法については、[コネクタ概要]()の記事を参照してください。
...
|オーディエンスセグメントからユーザーを削除 (オーディエンスマネージャ)| ✓| ✓|
 ...
 Adformセグメントコネクタは`UID`パラメータの送信をサポートしていません。`UID`パラメータが必要な場合、Adformは[Adformタグ]()の使用を推奨します。
