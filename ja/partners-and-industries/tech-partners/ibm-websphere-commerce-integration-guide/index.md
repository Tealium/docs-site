...
Tealium拡張機能は、TGZ形式のパッケージファイルとして配布されます：[tealium-websphere-commerce.tgz](/images/tech-partners/tealium-websphere-commerce.tgz)。
...
2. `tealium_udo_helper_1_2_0a.jar`ファイル（またはそれ以降のバージョン）を`/Stores/WebContent/WEB-INF/lib/`ディレクトリに配置します。![](/images/tech-partners/ibmwebsphere1.png)
...
1. **Provider Bundles**の下で**IBM WebSphere Commerce**を選択し、**Import This Bundle**をクリックします。![](/images/tech-partners/ibmwebsphere2.png)
1. **Close**をクリックします。
...
プロキシツールまたはChrome開発者ツールを使用して、ブラウザが`utag.js`ファイルをロードしていることを確認します。iQタグ管理でタグをアクティブにした後、Charles Proxy、HTTP Fox、またはChrome開発者ツールを使用して、アナリティクスベンダーにデータが渡されていることを確認できます。![](/images/tech-partners/ibmwebsphere3.png)
