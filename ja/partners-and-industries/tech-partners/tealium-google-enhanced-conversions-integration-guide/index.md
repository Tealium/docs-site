...
* Tealium
    * iQタグ管理：[Google Ads Conversion and Remarketing（gtag.js）タグ]()または[Floodlight（gtag.js）タグ]()
    * EventStream：[Google Ads Enhanced Conversions for Webコネクタ]()
* Google
...
以下の手順は、[Google Ads Conversion Tracking＆Remarketing（gtag.js）タグ構成ガイド]()で詳しく説明されています。
...
以下の手順は、[Google Ads Enhanced Conversions for Webコネクタ構成ガイド]()で詳しく説明されています。
