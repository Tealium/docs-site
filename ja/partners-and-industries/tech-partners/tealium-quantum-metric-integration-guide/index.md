...
詳細については、[Quantum Metric タグ](https://docs.tealium.com/quantum-metric-tag/)を参照してください。
...
1. これらのイベント属性を使用して、他の [AudienceStream 属性](https://docs.tealium.com/about-attributes/)でプロファイルを豊かにします。