...
* [アカウント管理者またはユーザー管理者](https://docs.tealium.com/admin-roles/)の権限。
* 長期間有効なベアラートークン。ベアラートークンの生成方法については、[認証](https://docs.tealium.com/about-scim-api/#authentication)を参照してください。
