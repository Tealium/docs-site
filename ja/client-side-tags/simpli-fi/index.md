---
title: Simpli.fiタグ構成ガイド
description: この記事では、Simpli.fiタグの構成方法について説明します。
url: https://docs.tealium.com/ja/client-side-tags/simpli-fi/
---
Simpli.fiは、キーワードを対象としたディスプレイ広告を行い、各キーワードに対してターゲティング、入札、レポート作成、最適化を行います。
