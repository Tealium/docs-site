---
title: エバーゲージタグ
description: この記事では、エバーゲージタグの構成方法について説明します。
url: https://docs.tealium.com/ja/client-side-tags/evergage-tag/
---
## タグのヒント
...
* **アカウント**: エバーゲージが提供するアカウント名。
* **データセットID**: エバーゲージでイベントを送信したいデータセットID（ラベルではない）。
