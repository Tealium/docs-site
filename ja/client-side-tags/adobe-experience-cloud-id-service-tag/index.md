...
まず、タグマーケットプレイスにアクセスし、プロファイルにExperience Cloud IDサービスタグを追加します（[タグを追加する](https://docs.tealium.com/manage-tags/#add-a-tag)を参照）。
...
マッピングは、[データレイヤー変数](https://docs.tealium.com/manage-data-mappings/)からベンダータグの対応する宛先変数にデータを送信するプロセスです。変数をタグの宛先にマッピングする方法については、[データマッピング](https://docs.tealium.com/manage-data-mappings/)を参照してください。
...
### イベント
イベントをマッピングするには、[イベントマッピングを作成する](https://docs.tealium.com/manage-data-mappings/#add-an-event-mapping)を参照してください。
