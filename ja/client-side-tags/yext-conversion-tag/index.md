---
title: Yext変換タグ構成ガイド
description: この記事では、Tealium iQタグ管理アカウントでYext変換タグを構成する方法について説明します。
url: https://docs.tealium.com/ja/client-side-tags/yext-conversion-tag/
---## タグのヒント

* マッピングを使用して、標準の構成値を上書きします。
* IDマッピングが入力されている場合、変換が発生します。
