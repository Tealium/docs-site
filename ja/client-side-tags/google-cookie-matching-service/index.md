...
* [同意管理]()またはCMP統合を使用して、訪問が広告または同等のカテゴリに同意した場合にのみタグが実行されるようにします。
...
データマッピングは、データレイヤー変数からベンダータグの対応する宛先変数へデータを送信するプロセスです。変数をタグの宛先にマッピングする方法についての説明は、[データマッピング](/ja/iq-tag-management/data-mappings/manage/)を参照してください。
