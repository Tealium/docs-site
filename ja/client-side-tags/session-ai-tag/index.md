...
セッションAIは、適切なデータ収集と訪問のインタラクションのために、セッションAI SDKおよびタグのロードルールを**すべてのページとイベント**（デフォルト）に構成することを推奨します。詳細については、[ロードルールについて](https://docs.tealium.com/about-load-rules/)を参照してください。
