---
title: モデルのデプロイ
description: この記事では、訓練済みモデルの1つ以上のバージョンをデプロイする方法について説明します。
url: https://docs.tealium.com/ja/server-side/predict/deploy/deploy-a-model/
---
...
1. このモデルのこのバージョンをデプロイしたいことを確認するために、再度**Deploy**をクリックします。  
あなたのモデルは現在、_バージョン2_で、ステータスは_デプロイには公開が必要_です。
1. 保存して公開します。  
あなたのモデルは現在、_バージョン2_で、ステータスは_現在デプロイ中_です。
