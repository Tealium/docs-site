...
url: https://docs.tealium.com/ja/server-side/predict/evaluate-models/strength-scores/
...
![](https://docs.tealium.com/images/predict/predictv2-live-scores.png)各再訓練は新たな独立したイベントを表し、これによりこの種の強度評価は静的であり、各バージョンに特定のものとなります。バージョンの評価は時間と共に変わりません。
