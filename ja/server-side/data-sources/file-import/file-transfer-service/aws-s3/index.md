...
プロファイルリージョンを確認するには、サーバーサイド管理メニューに移動し、**Server-Side Settings > Region**を選択します。リージョンを特定した後、[Tealium IPアドレスを許可する](https://docs.tealium.com/ip-allow-list/)から対応するVPCeを選択してください。
