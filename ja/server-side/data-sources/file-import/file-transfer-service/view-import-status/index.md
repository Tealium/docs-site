...
ファイルからインポートされたイベントを確認するには、**ライブイベント**画面に移動し、ドロップダウンリストからファイルインポートデータソースを選択します。詳細については、[About Live Events](https://docs.tealium.com/about-live-events/)を参照してください。