...
* Tealium Audience Discovery for Snowflakeでアクティブなオーディエンス。[オーディエンスの作成]()を参照してください。
...
完全な構成手順については、[Snowflakeクラウドデータソース]()を参照してください。
...
これらの手順は、標準のSnowflakeデータソースワークフローに従います。詳細については、[Snowflakeクラウドデータソース]()を参照してください。
