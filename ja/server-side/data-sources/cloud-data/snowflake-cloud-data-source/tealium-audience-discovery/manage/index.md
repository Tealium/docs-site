...
* Tealium Audience Discovery for SnowflakeがSnowflakeアカウントにインストールされ、必要なロールと権限が構成されていること。[Tealium Audience Discovery for Snowflakeのインストール]()の手順を参照してください。
...
[TealiumにSnowflakeオーディエンスを接続する]()ことで、アクティベーションのためのデータのロードを開始します。