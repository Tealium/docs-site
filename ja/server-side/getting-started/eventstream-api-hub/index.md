---
title: イベントストリームAPIハブ
description: オンラインおよびオフラインのデータ収集を管理し、データ品質を確保し、サーバーサイドの分析およびマーケティングツールと統合します。
url: https://docs.tealium.com/ja/server-side/getting-started/eventstream-api-hub/
---
### はじめに
...
オンラインおよびオフラインのデータ収集を管理し、データ品質を確保し、サーバーサイドの分析およびマーケティングツールと統合します。
...
オフラインおよびオンラインチャネルから顧客データをインポートします。
