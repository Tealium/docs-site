...
description: 顧客プロファイルを統合し、カスタムオーディエンスを構築し、リアルタイムパーソナライゼーションを管理します。
url: https://docs.tealium.com/ja/server-side/getting-started/audiencestream-cdp/
---
### はじめに
...
顧客プロファイルを統合し、カスタムオーディエンスを構築し、リアルタイムパーソナライゼーションを管理します。
