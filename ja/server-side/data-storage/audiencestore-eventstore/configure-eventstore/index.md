...
イベントフィードを有効にした後、**Store &gt; EventStore**に移動してJSONファイルを表示およびダウンロードします。各JSONファイルには、EventStreamからのイベントのリストが含まれています。また、サードパーティのツールを使用してファイルを表示することもできます。詳細については、[ファイルの表示]()を参照してください。
