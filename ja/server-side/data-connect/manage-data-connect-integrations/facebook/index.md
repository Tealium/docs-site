...
Tealium Connectデータソースを構成します。手順については、[Tealium Connectデータソースの構成](https://docs.tealium.com/tealium-connect-data-source/)を参照してください。

### ステップ2: FacebookからTealiumに新しいリードを送信する新しいレシピを作成

新しいレシピの作成方法の詳細については、[Data Connectでレシピを作成](https://docs.tealium.com/create-recipe-data-connect/)を参照してください。

レシピを作成して構成するための次のステップを完了します：

1. **DataConnect > Integrations**に移動し、Facebook Lead Adsアプリからトリガーされる新しいレシピを作成します。アプリからトリガーされるレシピの作成方法の詳細については、[Data Connectでレシピを作成](https://docs.tealium.com/create-recipe-data-connect/)の手順を参照してください。
1. レシピを構築するために：
    ...
    1. 新しいリード生成をTealiumに送信するアクションを構成します。詳細については、[アクションの構成](https://docs.tealium.com/create-recipe-data-connect/#step-2-configure-an-action)を参照してください。
...
1. オーディエンスを構成します。詳細については、[オーディエンスの作成](https://docs.tealium.com/manage-audiences/#create-an-audience)を参照してください。
1. **Connect > Audience Connectors**に移動します。
1. **+ Add Connector**をクリックし、[Salesforce Connector](https://docs.tealium.com/salesforce-connector/)を追加します。
1. **Source**ステップで、
...
1. **DataConnect > Integrations**に移動し、Salesforceアプリからトリガーされる新しいレシピを作成します。アプリからトリガーされるレシピの作成方法の詳細については、[Data Connectでレシピを作成](https://docs.tealium.com/create-recipe-data-connect/)の手順を参照してください。
1. レシピを構築するために：
    ...
    1. SalesforceからTealiumに新しい/更新されたレコードを送信するアクションを構成します。詳細については、[アクションの構成](https://docs.tealium.com/create-recipe-data-connect/#step-2-configure-an-action)を参照してください。
