...
Tealium Connectデータソースを構成します。詳細については、[Tealium Connectデータソースの構成](https://docs.tealium.com/tealium-connect-data-source/)を参照してください。
...
新しいレシピの作成方法については、[Data Connectでレシピを作成する](https://docs.tealium.com/create-recipe-data-connect/)を参照してください。

1. **DataConnect > Integrations**に移動します。
1. **Integrations**画面で、**Create > Recipe**をクリックします。
1. スケジュールアプリからトリガーされる新しいレシピを作成します。アプリからトリガーされるレシピの作成方法については、[Data Connectでレシピを作成する](https://docs.tealium.com/create-recipe-data-connect/)を参照してください。
...
追加情報については、[レシピの作成: アクションの構成](https://docs.tealium.com/create-recipe-data-connect/#step-2-configure-an-action)を参照してください。
