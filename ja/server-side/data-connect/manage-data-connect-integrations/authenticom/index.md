...
1. [サポートに連絡して](https://docs.tealium.com/support/)、レシピをデータコネクト環境にインポートしてもらいます。
...
[サポートに連絡して](https://docs.tealium.com/support/)、環境に統合をインポートしてもらいます。
...
詳細については、[レシピの作成：アクションの構成](https://docs.tealium.com/create-recipe-data-connect/#step-2-configure-an-action)を参照してください。
