...
---
リンクが完了すると、[Advanced JavaScript Code extension]()を使用してGitHubリポジトリからファイルを参照し、同期することができます。コードはGitHubに安全に保管されていますが、iQタグ管理の構成で公開することができます。
...
* GitHubおよびGitHubリポジトリの操作に関する知識と経験。
 ...
 GitHubを使用していない場合や公開リポジトリを持っていない場合は、GitHubにリンクする代わりにを使用することをお勧めします。
