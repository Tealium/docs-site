...
1. **パスワード**フィールドにパスワードを入力します。
    &#43; パスワードを忘れた場合は、**パスワードを忘れた方はこちら**をクリックします。詳細は[パスワードのリセット方法は？](/ja/iq-tag-management/frequently-asked-questions/how-do-i-reset-my-password/)を参照してください。
1. **ログイン**をクリックします。
...
MFAが有効なアカウントにログインする方法については、[マルチファクタ認証]()を参照してください。
...
[組織のSSO用のアイデンティティ管理ソリューション]()は、サードパーティのプロバイダを使用するか、自己ホスト型の認証システムを使用することができます。
