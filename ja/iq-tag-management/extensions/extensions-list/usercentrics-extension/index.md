...
1. **iQ Tag Management** の Usercentrics 構成ダイアログに戻り、**インポート** ボタンをクリックします。  
...
1. ブックマークレットは自動的に **Tealium iQ Tag Management** と **Usercentrics** のリスト項目をマッピングテーブルに追加します。
1. 同意強制に使用されない **Tealium iQ Tag Management** と **Usercentrics** サービスを削除するためにゴミ箱アイコンを使用します。
...
いいえ。iOSやAndroidなどのモバイルインストールでは、Tealium iQ Tag Management Usercentrics 拡張機能はサポートされていません。
