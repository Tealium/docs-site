---
title: タグ管理
description: タグ管理は、ページコードを編集することなくタグを管理するためのウェブインターフェースです。ウェブサイトのハードコーディングされたタグを単一のタグに置き換え、長い開発サイクルを必要とせずに簡単にタグを管理できます。
...
タグ管理が初めてですか？ここから始めて、その仕組みを学びましょう。
...
サイトにインストールする準備ができたら、「環境管理」を訪れてください。
...
プロファイルへの更新を開発、テスト、公開するためのベストプラクティス。
...
訪問の一般的なインタラクションを追跡するイベントを構成します。
...
データレイヤーを変更する必要がある、またはイベント追跡を追加する必要がある場合、そのための拡張機能があります。
...
訪問からリアルタイムで好みや感情（ゼロパーティデータ）を直接収集します。
...
Tealium以外の同意管理プラットフォームによってキャプチャされたエンドユーザーの同意決定を適用します。


## 保存と公開

協力的な開発環境でタグ構成の複数のバージョンを管理および公開します。
