...
[同意管理について詳しく学ぶ](/ja/platforms/getting-started-mobile/consent-management/).
...
同意管理を有効にするには、[`TealiumConfig`](/ja/platforms/xamarin/api/#consentpolicy)を初期化するときに`consentPolicy`パラメータを構成します：
...
* [`SetConsentStatus()`](/ja/platforms/xamarin/api/#setconsentstatus)
* [`GetConsentStatus()`](/ja/platforms/xamarin/api/#getconsentstatus)
* [`SetConsentCategories()`](/ja/platforms/xamarin/api/#setconsentcategories)
* [`GetConsentCategories()`](/ja/platforms/xamarin/api/#getconsentcategories)
* [`SetConsentExpiryListener()`](/ja/platforms/xamarin/api/#setconsentexpirylistener)

`Tealium.Common.dll`は以下のカテゴリとステータスの列挙を提供します：

* [`Tealium.ConsentManager.ConsentStatus`](/ja/platforms/xamarin/api/#consentstatus)
* [`Tealium.ConsentManager.ConsentCategory`](/ja/platforms/xamarin/api/#consentcategory)
