...
* [Tealium for Android](/ja/platforms/android-java/)を使用したAndroidWearアプリ
...
[`trackView()`](/ja/platforms/android-java/api/tealium/#trackview)メソッドは、以下の例に示すように、画面ビューをトラッキングします：
...
[`trackEvent()`](/ja/platforms/android-java/api/tealium/#trackevent)メソッドは、以下の例に示すように、非ビューイベントをトラッキングします：
