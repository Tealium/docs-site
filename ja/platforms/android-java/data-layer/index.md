...
<blockquote>
これらの変数は、[モバイル用のプロファイルを有効化する](https://docs.tealium.com/creating-a-mobile-profile/)ときに、あなたのTealium iQタグ管理アカウントに追加されます。
</blockquote>


追加の変数は、5.0.x用の[ライフサイクルトラッキングモジュール](https://docs.tealium.com/ja/platforms/android/lifecycle-tracking-module/)で利用できます。
