...
ディープリンクの自動トラッキングを無効にするには、[`deepLinkTrackingEnabled`](https://docs.tealium.com/ja/platforms/android-kotlin/api/tealium-config/#deeplinktrackingenabled)プロパティを`false`に構成します。
