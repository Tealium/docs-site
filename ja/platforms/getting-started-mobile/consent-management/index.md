...
| **拒否**  | トラッキングコールが送信されます。&lt;br&gt;[`do_not_sell`](#data-layer)フラグは`true`に構成されます。&lt;br&gt;[CCPA同意マネージャ](/ja/iq-tag-management/consent-management/privacy-banner-and-popup/manage/)の「影響を受けるタグ」セクションで構成されたタグはトリガーされません。 |
...
* [Android (Java)](/ja/platforms/android-java/consent-management/) - ライブラリに含まれ、初期化時にネイティブコードで有効化されます。
* [Android (Kotlin)](/ja/platforms/android-kotlin/consent-management/) - ライブラリに含まれ、初期化時にネイティブコードで有効化されます。
* [Cordova](/ja/platforms/cordova/)
* [iOS (Objective-C)](/ja/platforms/ios-objective-c/consent-management/) - CocoaPodsフレームワークビルドに含まれています。
* [iOS (Swift)](/ja/platforms/ios-swift/consent-management/) - `ConsentManager`モジュールがPodfileに追加されたときに、CarthageとCocoaPodsフレームワークビルドで含まれ、有効化されます。
* [React Native](/ja/platforms/react-native/)
* [Xamarin](/ja/platforms/xamarin/consent-mangagement/)

全機能の比較については、[モバイル機能比較]()を参照してください。
