...
詳細については、[同意管理](/ja/platforms/getting-started-mobile/consent-management/)を参照してください。
...
同意管理を有効にするには、[`TealiumConfig`](/ja/platforms/dotnet-maui/api/#consentpolicy)を初期化するときに`consentPolicy`パラメータを構成します：
...
* [`SetConsentStatus()`](/ja/platforms/dotnet-maui/api/#setconsentstatus)
* [`GetConsentStatus()`](/ja/platforms/dotnet-maui/api/#getconsentstatus)
* [`SetConsentCategories()`](/ja/platforms/dotnet-maui/api/#setconsentcategories)
* [`GetConsentCategories()`](/ja/platforms/dotnet-maui/api/#getconsentcategories)
* [`SetConsentExpiryListener()`](/ja/platforms/dotnet-maui/api/#setconsentexpirylistener)

`Tealium.Common.dll`は以下のカテゴリとステータスの列挙型を提供します：

* [`Tealium.ConsentManager.ConsentStatus`](/ja/platforms/dotnet-maui/api/#consentstatus)
* [`Tealium.ConsentManager.ConsentCategory`](/ja/platforms/dotnet-maui/api/#consentcategory)
