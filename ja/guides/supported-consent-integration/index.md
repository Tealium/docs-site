...
---
このガイドでは、Tealium iQタグ管理システムとOneTrust同意統合を使用しますが、この構成は[サポートされているベンダー統合]()のいずれにも適用できます。このガイドの終わりまでに、OneTrustまたは他のサポートされている同意管理プラットフォーム（CMP）を選択し、Tealium iQで関連する施行を統合して、ユーザーの構成を尊重するタグが正しく機能するように構成します。
...
同意統合はTealiumの[デバッグモード](/ja/platforms/javascript/debugging/)にも追加情報を提供します。

1. [デバッグモード](/ja/platforms/javascript/debugging/)を有効にして、同意統合情報を表示します。
