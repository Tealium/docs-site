...
小売のデータレイヤー定義についての詳細は、[Retail]()を参照してください。
...
ディスカウントショッパーの属性を定義したら、これらの属性はTealiumのソリューション、例えばMoments APIのようなものでパーソナライゼーションにも使用できます。詳細は、[Moments APIについて]()をご覧ください。