...
1. To enable or disable tag refire for each tag, toggle the **OFF/ON** button under the **Tag Refire** column. For more information about tag refire, [Tag refire](https://docs.tealium.com/about-consent-integrations/#tag-refire).
...
For a step-by-step example of how to set up a supported vendor integration with Tealium iQ tag management, see [consent integration guide](https://docs.tealium.com/supported-consent-integration/).