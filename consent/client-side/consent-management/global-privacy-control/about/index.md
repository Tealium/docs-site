...
For more information on Tealium's support for GPC, see [Client-side Global Privacy Control](https://docs.tealium.com/client-side-global-privacy-control/) and [Server-side Global Privacy Control](https://docs.tealium.com/server-side-global-privacy-control/).
