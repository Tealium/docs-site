...
| `tealium_datasource` | (Optional) The data source key. For more information, see [ Data Sources](https://docs.tealium.com/about-data-sources/). |
...
| `tealium_trace_id` | (Optional) For use with [Trace](https://docs.tealium.com/manage-traces/). |
...
Additional event attributes are sent as custom parameters according to your tracking needs. Define these parameters as [event attributes in the Tealium Customer Data Hub](https://docs.tealium.com/add-enrichment/).
