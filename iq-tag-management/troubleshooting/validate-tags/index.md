...
* First, use Web Companion or the Universal Tag Monitor to verify the data layer variables used in your page and event tracking calls. [Learn more](https://docs.tealium.com/platforms/javascript/install/#validate-installation).
