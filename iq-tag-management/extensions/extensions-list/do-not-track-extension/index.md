...
![](https://docs.tealium.com/images/iq-tag-management/chrome-do-not-track.png)
...
![](https://docs.tealium.com/images/iq-tag-management/do-not-track-load-rule.png)

Include this load rule on any tags that should honor the DNT setting, like this:

![](https://docs.tealium.com/images/iq-tag-management/do-not-track-load-rule-tag.png)
