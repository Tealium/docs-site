...
* Version 4.43, or greater, of the Universal Tag (`utag.js`) is required. For more information, see [Upgrade to the latest utag.js.](https://docs.tealium.com/template-status-checker/)
...
Yes. To learn about the Hosted Data Layer feature for mobile, see [Hosted Data Layer](https://docs.tealium.com/platforms/getting-started-mobile/hosted-data-layer/).
