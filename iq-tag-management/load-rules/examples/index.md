...
![](https://docs.tealium.com/images/iq-tag-management/load-rules-and-logic.png)
...
![](https://docs.tealium.com/images/iq-tag-management/load-rules-or-logic.png)
...
![](https://docs.tealium.com/images/iq-tag-management/load-rules-domain.png)

## Using domain and pathname

To load tags on the homepage for `domain1.com`, use the following rule:

![](https://docs.tealium.com/images/iq-tag-management/load-rules-domain-pathname.png)
...
![](https://docs.tealium.com/images/iq-tag-management/load-rules-any-support-page.png)
...
![](https://docs.tealium.com/images/iq-tag-management/load-rules-support-query-string.png)
...
The date and time range dialog appears.  
    ![](https://docs.tealium.com/images/iq-tag-management/load-rules-date-time-range.png)
