...
The **UID** column displays the numeric identifier for each load rule. This value can be useful when [debugging utag.js](https://docs.tealium.com/platforms/javascript/debugging/).
...
For more information about how load rules work with events, see [Event Rules Examples](https://docs.tealium.com/event-rules/).

For more information about how load rules, events, and tags interact, see [Subscribe a tag to an event](https://docs.tealium.com/subscribe-tag-to-event/).
...
* **Tags**: The [tags](https://docs.tealium.com/about-tags/) scoped to the load rule. To go to a scoped tag, click the tag.
* **Events**: The [events](https://docs.tealium.com/manage-events/#view-event-details) that use the load rule.
* **Consent**: Information about [consent](https://docs.tealium.com/about-consent-management/) that is linked to this rule.
* **Extensions**: The [extensions](https://docs.tealium.com/about-extensions/) that use the load rule.
