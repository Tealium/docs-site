...
url: https://docs.tealium.com/iq-tag-management/getting-started/iq-dashboard/
---
## How it works
...
* [Save/Publish](https://docs.tealium.com/save-publish-a-version/): Save and publish your changes to the version.
...
* [Concurrent Users](https://docs.tealium.com/concurrent-users/): This icon appears if other users are logged on and using the profile. Click the icon to view see which users they are and to post a message to anyone who views the profile.
