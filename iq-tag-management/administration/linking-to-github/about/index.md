...
---
Once linked, use the [Advanced JavaScript Code extension](https://docs.tealium.com/advanced-javascript-code-extension/) to reference and synchronize files from a GitHub repository. Your code remains safely stored in GitHub, but is available to publish in your iQ Tag Management configuration.
...
<blockquote>
If you do not use GitHub or do not have a public repository, we recommend that you use the [iq-javascript-extension-api](https://docs.tealium.com/iq-javascript-extension-api/) instead of linking to GitHub.
</blockquote>
