...
<blockquote>
If you do not use GitHub or do not have a public GitHub repository, we recommend that you use the [iq-javascript-extension-api](https://docs.tealium.com/iq-javascript-extension-api/) instead of linking to GitHub.
</blockquote>
...
![](https://docs.tealium.com/images/iq-tag-management/new-personal-access-token-2021-06-08-13-13-33.png)
...
1. Click **Link Account**.  
        ![](https://docs.tealium.com/images/iq-tag-management/manage-github-account-new.jpg)
...
If the issue persists, consider using [iq-javascript-extension-api](https://docs.tealium.com/iq-javascript-extension-api/) instead of linking to GitHub.
