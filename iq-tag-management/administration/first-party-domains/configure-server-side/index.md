...
1. Click **I Agree** to give Tealium permission to manage certificates for the provided domains and to certify you own and manage these domains, then click **Save**.
    * **DNS validation**: Temporary A records (one for each domain) that are used for validation are displayed:![](https://docs.tealium.com/images/guides/iq/fpd-dns-confirm-server-side.png) Add these temporary A records to your DNS configuration.
    * **Email validation**: The following message is displayed:
![](https://docs.tealium.com/images/iq-tag-management/generated-email-confirm.png)
