...
Learn more about [bundling and page performance](https://docs.tealium.com/page-performance/).
...
This will generate a distribution archive of all generated tag files. For more information, see [Self hosting](https://docs.tealium.com/self-hosting/#enable-the-zip-archive).
* **Cookies Domain**  
...
<blockquote>
Enabling this feature allows your website to set a cookie with any arbitrary value, which could expose your system to code injections. This feature is offered as a convenience for those who cannot use the Google Chrome browser. If you can use Chrome, we recommend using the [Tealium Tools Environment Switcher](https://docs.tealium.com/iq-tag-management/tealium-tools/environment-switcher/) as a best practice.
</blockquote>
