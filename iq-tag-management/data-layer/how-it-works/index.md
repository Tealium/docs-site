...
---
The following terms are related to a website data layer and your [installation of `utag.js`](https://docs.tealium.com/platforms/javascript/install/):
...
Learn more about [how the UDO works](https://docs.tealium.com/platforms/javascript/about-utag-data/).
...
Learn more about the [data layer variable types](https://docs.tealium.com/data-layer-variables/).
...
Learn more about the [built-in variables available in the UDO](https://docs.tealium.com/platforms/javascript/built-in-variables/).
...
Learn more about [the `b` object and how it's used](https://docs.tealium.com/platforms/javascript/the-b-object/).
...
Learn more about the [order of operations of the Tealium Javascript library](https://docs.tealium.com/order-of-operations/).
