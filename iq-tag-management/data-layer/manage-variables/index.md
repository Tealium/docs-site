...
The **Data Layer** tab offers several ways to manage the variables in your data layer. Each variable that you implemented on your website must also be created here so that it can be used in your configuration. In addition to the [dynamic data you populate in your site's Universal Data Object (UDO)](https://docs.tealium.com/platforms/javascript/about-utag-data/), a number of other built-in variables from your pages are available to be added from this screen.
...
1. Enter the following fields:
    ...
    * **Notes**: Useful comments about the Variable, especially useful for the next person that uses your account. Click **AI Note** to generate notes with AI. For more information, see [AI Note Generation](https://docs.tealium.com/ai-features/#ai-note-generation).
