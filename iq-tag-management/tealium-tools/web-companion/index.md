...
1. Install the [Tealium Tools browser plugin](https://docs.tealium.com/tealium-tools-browser-extension/).
...
The Universal Data object (UDO), or `utag_data`, view shows the detected data object on the page. For more information, see the guide to [the data layer for websites.](https://docs.tealium.com/how-the-data-layer-works-for-websites/).
...
Add this extension to modify the content you want on the page. Configure the extension and click **Add to Queue** to save it to your profile. For more details, see [Adobe Test and Target Extension](https://docs.tealium.com/adobe-target-extension/).
