...
The Tealium extension is distributed as a packaged file in TGZ format: [tealium-websphere-commerce.tgz](https://docs.tealium.com/images/tech-partners/tealium-websphere-commerce.tgz).
...
2. Place the `tealium_udo_helper_1_2_0a.jar` file (or later version) into the `/Stores/WebContent/WEB-INF/lib/` directory.![](https://docs.tealium.com/images/tech-partners/ibmwebsphere1.png)
...
Data Sources**.
1. Under **Provider Bundles**, select **IBM WebSphere Commerce** and click **Import This Bundle**.![](https://docs.tealium.com/images/tech-partners/ibmwebsphere2.png)
1. Click **Close**.
