...
* **Key Attributes**
    * **Lead Score** ([Number](https://docs.tealium.com/number-attribute/))  
    ...
    * **Visitor Value** ([String](https://docs.tealium.com/string-attribute/))  
...
In order for Google Analytics to properly store the hit from the Webhook, the Google Analytics Visitor ID must be provided in the [Webhook](https://docs.tealium.com/webhook-connectors/). This is done in Tealium iQ by parsing the cookie `_ga` using a **Set Data Values extension** and storing the 2 longest numbers at the end of the cookie value into a data layer variable. Declare `_ga` as type **First Party Cookie**, and `google_visitorid` as type `UDO Variable` in your **Data Layer** tab. Then create the [Set Data Values extension](https://docs.tealium.com/set-data-values-extension/) as seen below.
...
![](https://docs.tealium.com/images/server-side/google-analytics-visitor-id.png)

The `google_visitorid` value can then be stored as a a string.

![](https://docs.tealium.com/images/server-side/set-string-to-google-visitorid.png)

We will set a [Boolean](https://docs.tealium.com/boolean-attribute/) to check if the data exists. This is important because the value stored in `google_visitorid` is required for Google Analytics to save the data received from the connector.

![](https://docs.tealium.com/images/server-side/set-boolean-google-visitor-id.png)

Last, we will eventually map the data to the `cid` parameter in the Webhook that we build for Google Analytics

![](https://docs.tealium.com/images/server-side/map-to-cid.png)
...
![](https://docs.tealium.com/images/server-side/lead-score-lifetime.png)

For all events with positive points, increment the **Lead Score** by the value you want.

![](https://docs.tealium.com/images/server-side/increment-decrement-lead-score.png)
...
![](https://docs.tealium.com/images/server-side/lead-score-support-user.png)
...
![](https://docs.tealium.com/images/server-side/ls-greater-equal-3.png)
...
![](https://docs.tealium.com/images/server-side/string-visitor-value.png)
...
![](https://docs.tealium.com/images/server-side/high-value-audience.png)

### Standard Visitors

When **Visitor Value** is `Standard Visitor`, visitor is a member of this audience.

![](https://docs.tealium.com/images/server-side/standard-audience.png)

## Step 5: Configure webhook (Google Analytics and AudienceStream)

### Custom Dimensions

Create **Custom Dimensions** in Google Analytics that the [Webhook](https://docs.tealium.com/webhook-connectors/) will populate.

![](https://docs.tealium.com/images/server-side/no-title-168i3748718d3d7cc6ec.png)

### Webhook Example

The following example configuration is used to trigger the data to Google Analytics.

![](https://docs.tealium.com/images/server-side/google-analytics-configurations.png)
...
![](https://docs.tealium.com/images/server-side/two-connectors.png)
...
![](https://docs.tealium.com/images/server-side/no-title-171i447e852b607fbd60.png)

### Example: Remarketing list based on High Value Visitor

![](https://docs.tealium.com/images/server-side/no-title-172i85ee1c061f359fca.png)
